...
class Tree extends React.Component {
  componentWillMount() {
    ...
    const mazeWidth = isMobile ? this.props.width / 2 : this.props.width;
    const mazeHeight = isMobile ? this.props.height / 2 : this.props.height;
    ...
    this.maze = new Maze(mazeWidth, mazeHeight, center);
  }
  ...
  componentDidMount() {
    ...
    const interval = setInterval(() => {
      this.maze.draw(context, context.canvas.width, context.canvas.height);
